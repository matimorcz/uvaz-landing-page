  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  An innovative inflation-protected stablecoin pegged to initially to Argentina's UVA index and backed inflation-indexed
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <Card className="relative overflow-hidden">
                <CardContent className="p-6">
                  <Shield className="h-12 w-12 mb-4 text-[#e91e63]" />
              ...
              <Card className="relative overflow-hidden">
                <CardContent className="p-6">
                  <Lock className="h-12 w-12 mb-4 text-[#e91e63]" />
              ...
              <Card className="relative overflow-hidden">
                <CardContent className="p-6">
                  <LineChart className="h-12 w-12 mb-4 text-[#e91e63]" />
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3 lg:gap-12">
                <div className="flex flex-col items-center space-y-4">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#e91e63] text-white">1</div>
                ...
                <div className="flex flex-col items-center space-y-4">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#e91e63] text-white">2</div>
                  <h3 className="text-xl font-bold">Stability</h3>
                  <p className="text-gray-500">Keep your purchasing power, forget about inflation.</p>
                </div>
                <div className="flex flex-col items-center space-y-4">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#e91e63] text-white">3</div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3 lg:gap-12">
                ...
                <Card>
                  <CardContent className="p-6">
                    <CheckCircle className="h-12 w-12 mb-4 text-[#e91e63]" />
                ...
                <Card>
                  <CardContent className="p-6">
                    <Wallet className="h-12 w-12 mb-4 text-[#e91e63]" />
        ...
        {/* CTA Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 bg-[#e91e63]">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center text-white">
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row items-center justify-center mt-8">
                ...
                <Button variant="outline" className="border-white text-white hover:bg-white hover:text-[#e91e63]">
                  Read Whitepaper
          ...
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                <li>
                  <Link className="hover:text-[#e91e63]" href="#">
                    Our Story
                  </Link>
                </li>
                <li>
